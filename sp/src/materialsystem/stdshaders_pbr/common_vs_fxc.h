...
// This routine uses booleans to do early-outs and is meant to be called by routines OUTSIDE of this file
// This is the Source SDK 2007 version of the function. It's used to compile the older code.
float GetVertexAttenForLight_SDK07( const float3 worldPos, int lightNum )
{
	float result = 0.0f;
	if ( g_bLightEnabled[lightNum] )
	{
