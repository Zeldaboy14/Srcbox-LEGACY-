...
ConVar cr_ssao_samples( "cr_ssao_samples", "25" );
ConVar cr_ssao_contrast( "cr_ssao_contrast", "0.5" );
ConVar cr_ssao_radius( "cr_ssao_radius", "50" );
ConVar cr_ssao_bias( "cr_ssao_bias", "-0.4" );
ConVar cr_ssao_bias_offset( "cr_ssao_bias_offset", "0.05" );
ConVar cr_ssao_illuminfluence( "cr_ssao_illuminfluence", "1" );
ConVar cr_ssao_zfar( "cr_ssao_zfar", "8" );
ConVar cr_ssao_znear( "cr_ssao_znear", "0.005" );
