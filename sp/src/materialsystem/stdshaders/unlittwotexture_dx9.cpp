...
//DEFINE_FALLBACK_SHADER( FBCK_UnlitTwoTexture, UnlitTwoTexture_SDK )
BEGIN_VS_SHADER( UnlitTwoTexture_SDK, "" )
	BEGIN_SHADER_PARAMS
		...
		if ( bDrawStandardPass )
		{
			...
			DYNAMIC_STATE
			{
				...
				if( g_pHardwareConfig->SupportsPixelShaders_2_b() )
				{
					...
					SET_DYNAMIC_PIXEL_SHADER_COMBO(LIGHTING_PREVIEW, pShaderAPI->GetIntRenderingParameter(INT_RENDERPARM_ENABLE_FIXED_LIGHTING));
